...
export default async function PaidApp() {
      ...
      <header className="border-b border-white/10 bg-zinc-950/80 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 sm:px-10 lg:px-12">
          <div>
            ...
            <div className="text-xs text-zinc-400">Paid dashboard</div>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.4fr_0.9fr] lg:items-end">
            <div>
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-zinc-300 sm:text-lg">
                VibeTrendr watches the market, surfaces what’s heating up, and keeps the idea queue moving without
                turning into another bloated dashboard.
              </p>
              ...
              {topSignal ? (
                <div className="mt-6 rounded-3xl border border-emerald-400/20 bg-zinc-950/45 p-5 shadow-[0_0_0_1px_rgba(16,185,129,0.04)]">
                  ...
                  <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-300">{topSignal.primary.description}</p>
        ...
        <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-zinc-400">Latest rows from Supabase, shown read-only for quick review.</p>
            </div>
            <div className="text-sm text-zinc-400">{supabaseStatus.ready ? "Connected" : "Not connected"}</div>
          </div>
